...
MD_PATH = "2026-07-17-AI-Daily.md"
HTML_PATH = "2026-07-17-AI-Daily.html"
...
def build_body(md_text):
    ...
    for li, line in enumerate(lines):
        ...
        if s.startswith("# "):
            ...
            # 普通引用块（如开篇说明、维度补充说明、弹性原则说明）
            content = s[1:].strip()
            if content == "":
                continue
            # 凡 📌 标记的说明性引用，或开篇概览，统一升级为 note-card
...
<title>AI 行业每日热点深度简报 · 2026-07-17</title>
<style>{css}</style>
</head>
<body>
<div class="container">
